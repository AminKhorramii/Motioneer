...
export const PRESETS: Taste[] = [
  {
    ...
    display: GROTESK, body: SANS, scale: 1.38, radius: 20, density: 0.45, weight: 800, caps: false, motion: 'lively',
  },
  {
    name: 'spaceship',
    bg: '#05070f', ink: '#dbe7ff', dim: '#6a7a9c', accent: '#4dd8ff', accent2: '#8b7bff',
    display: MONO, body: SANS, scale: 1.3, radius: 2, density: 0.7, weight: 600, caps: true, motion: 'soft',
  },
  {
    name: 'neon',
    bg: '#0a0510', ink: '#f4e9ff', dim: '#8a76a0', accent: '#ff2fd0', accent2: '#7cf7ff',
    display: GROTESK, body: SANS, scale: 1.44, radius: 0, density: 0.6, weight: 800, caps: false, motion: 'lively',
  },
  {
    name: 'gallery',
    bg: '#fbfaf8', ink: '#0d0d0c', dim: '#77746e', accent: '#0d0d0c', accent2: '#9a8f7a',
    display: SERIF, body: SERIF, scale: 1.5, radius: 0, density: 0.32, weight: 400, caps: true, motion: 'still',
  },
  {
    name: 'quiet dark',
