...
export const Icon = {
  ...
  up: () => <S><path d="M8 12.5V4M4.5 7.5 8 4l3.5 3.5" /></S>,
  down: () => <S><path d="M8 3.5V12M4.5 8.5 8 12l3.5-3.5" /></S>,
  ...
  copy: () => <S><rect x="5.5" y="5.5" width="8" height="8" rx="1.6" /><path d="M10.5 3.5H3.8c-.7 0-1.3.6-1.3 1.3v6.7" /></S>,
