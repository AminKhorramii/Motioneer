...
sections: the argument of the page in order, as a list from masthead, claim, proof, substance, offer, objections, invitation, credits. Open with masthead unless the idea is a poster or a printed object that would never carry a nav, because a page with nothing above its headline reads as a mock rather than a site. Four to nine of them, repeats allowed. This is the shape of the page and it is yours to decide: a receipt is substance and an offer, not proof and a pricing grid; a poster is a claim and an invitation; a field manual is mostly substance and objections. Leave out anything the idea does not need.
