...
export type Wire = 'anthropic' | 'openai' | 'cli'
...
export const MODELS: ModelChoice[] = [
  {
    id: 'claude-code', label: 'Claude Code', wire: 'cli', base: '', model: '',
    keyName: '', keys: 'no key needed',
    note: 'Uses the Claude you already have on this machine. Nothing to configure.',
  },
  {
...
export const MARKS: Record<string, () => React.ReactElement> = {
  'claude-code': brand(CLAUDE_PATH, '#D97757'),
  claude: brand(CLAUDE_PATH, '#D97757'),
  gpt: brand(
