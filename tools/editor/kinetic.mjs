...
export function normalizeReel(raw,{brand,domain,seconds=12,palette,captures=[],music,art,concept}={}){
...
export async function kineticReel({at,brand,domain,projectId,url,mode='graphic',direction='',seconds=12,palette,music,art,concept,plan:provided,onStep=()=>{}}){
 ...
 const plan=normalizeReel(reply.json,{brand,domain,seconds,palette,captures:inventory.captures,music,art,concept})
