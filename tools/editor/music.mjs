...
export function musicWav({seconds,seed='film',bpm=128,cuts=[],music={}}){
 ...
 const plan=musicPlan(music,seed),p=MUSIC[plan.profile],sr=48000,N=Math.ceil(seconds*sr),L=new Float32Array(N),R=new Float32Array(N),sendL=new Float32Array(N),sendR=new Float32Array(N),tau=Math.PI*2
